...
def show_go_screen():
    ...
    draw_text(screen, "FROZEN", 64, WIDTH / 2, HEIGHT / 4)
...
powerup_images = {}
powerup_images['shield'] = pygame.image.load(path.join(img_dir, "C:\heart_teal.png")).convert()
powerup_images['gun'] = pygame.image.load(path.join(img_dir, "C:\heart_purple.png")).convert()
# Load all game sounds
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, "C:\y2mate.com - Sparkle Sound Effect.mp3"))
shield_sound = pygame.mixer.Sound(path.join(snd_dir, "C:\y2mate.is - Ice Magic Circle Sound Effect-oWOpr5zjBTo-192k-1701597257.mp3"))
power_sound = pygame.mixer.Sound(path.join(snd_dir, "C:\y2mate.is - Doraemon Props Sound FX HD -Kb-cmAOVl_w-192k-1701598376.mp3"))
expl_sounds = []
for snd in ["C:\y2mate.com - Freeze  Sound Effect HD.mp3", "C:\y2mate.com - Freeze  Sound Effect HD.mp3"]:
    expl_sounds.append(pygame.mixer.Sound(path.join(snd_dir, snd)))
player_die_sound = pygame.mixer.Sound(path.join(snd_dir, "C:\y2mate.is - BOOM CUTE SOUND EFFECT-_10vrezlzhY-192k-1701597754.mp3"))
